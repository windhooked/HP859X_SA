...
func TestMachineBootScreen(t *testing.T) {
	// Revived (2026-05-30): the A16 analog-bus conversion model
	// (docs/ANALOG_BUS_MODEL.md) plus M68K_EMULATE_ADDRESS_ERROR (the firmware
	// recovers from malformed-DLP dispatch via the 68000 address-error
	// exception — see docs/DLP_STARTUP_DERAIL.md) let the boot run the startup
