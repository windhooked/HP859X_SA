...
var glyphFont = map[[glyphRows]uint16]string{
	...
	// --- extended 2026-06-02: decoded from screens/glyphs.log (cal-data text) ---
	{0x0010, 0x0028, 0x0008, 0x0008, 0x001C, 0x0008, 0x0008, 0x0000}: "t",
	{0x0000, 0x0008, 0x0010, 0x003E, 0x0010, 0x0008, 0x0000, 0x0000}: ">",
	{0x0022, 0x0012, 0x000A, 0x001E, 0x0022, 0x0022, 0x001E, 0x0000}: "R",
	{0x001C, 0x0022, 0x0020, 0x001C, 0x0002, 0x0022, 0x001C, 0x0000}: "S",
	{0x0022, 0x0036, 0x002A, 0x002A, 0x0022, 0x0022, 0x0022, 0x0000}: "W",
	{0x0008, 0x0014, 0x0014, 0x0022, 0x0022, 0x0022, 0x0022, 0x0000}: "V",
	{0x0022, 0x0022, 0x0022, 0x003E, 0x0022, 0x0014, 0x0008, 0x0000}: "A",
	{0x0002, 0x0002, 0x0002, 0x000E, 0x0002, 0x0002, 0x003E, 0x0000}: "F",
	{0x001C, 0x0022, 0x0022, 0x0022, 0x0022, 0x0022, 0x001C, 0x0000}: "O",
	{0x001C, 0x0022, 0x0022, 0x003A, 0x0002, 0x0022, 0x001C, 0x0000}: "G",
	{0x001C, 0x0022, 0x0002, 0x0002, 0x0002, 0x0022, 0x001C, 0x0000}: "C",
	{0x0022, 0x0022, 0x0032, 0x002A, 0x0026, 0x0022, 0x0022, 0x0000}: "N",
	{0x0022, 0x0012, 0x000A, 0x0006, 0x000A, 0x0012, 0x0022, 0x0000}: "K",
	{0x003E, 0x0004, 0x0008, 0x0010, 0x0020, 0x0022, 0x001C, 0x0000}: "2",
	{0x001C, 0x0020, 0x001C, 0x0002, 0x001C, 0x0000, 0x0000, 0x0000}: "s",
	{0x001C, 0x0002, 0x003E, 0x0022, 0x001C, 0x0000, 0x0000, 0x0000}: "e",
	{0x001C, 0x0022, 0x0002, 0x0022, 0x001C, 0x0000, 0x0000, 0x0000}: "c",
	{0x001C, 0x0022, 0x0022, 0x001C, 0x0022, 0x0022, 0x001C, 0x0000}: "8",
	{0x001E, 0x0022, 0x0022, 0x0022, 0x0022, 0x0000, 0x0000, 0x0000}: "u",
	{0x0000, 0x0000, 0x0000, 0x003E, 0x0000, 0x0000, 0x0000, 0x0000}: "-",
	{0x001C, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x001C, 0x0000}: "I",
	{0x001C, 0x0022, 0x0020, 0x001E, 0x0002, 0x0002, 0x003E, 0x0000}: "5",
	{0x0010, 0x0010, 0x003E, 0x0012, 0x0014, 0x0018, 0x0010, 0x0000}: "4",
	{0x001C, 0x0020, 0x0020, 0x003C, 0x0022, 0x0022, 0x001C, 0x0000}: "9",
	{0x001C, 0x0022, 0x0022, 0x0022, 0x0022, 0x0022, 0x0022, 0x0000}: "U",
	{0x002C, 0x0012, 0x002A, 0x0022, 0x0022, 0x0022, 0x001C, 0x0000}: "Q",
	{0x003E, 0x0002, 0x0004, 0x0008, 0x0010, 0x0020, 0x003E, 0x0000}: "Z",
	{0x001C, 0x0022, 0x0022, 0x0022, 0x001C, 0x0000, 0x0000, 0x0000}: "o",
	{0x0002, 0x0002, 0x0002, 0x0026, 0x001A, 0x0000, 0x0000, 0x0000}: "r",
	{0x0004, 0x0004, 0x0004, 0x000E, 0x0004, 0x0014, 0x0008, 0x0000}: "t",
	{0x0000, 0x0018, 0x0018, 0x0000, 0x0018, 0x0018, 0x0000, 0x0000}: ":",
	{0x001C, 0x0022, 0x0022, 0x001E, 0x0002, 0x0002, 0x001C, 0x0000}: "6",
	{0x0008, 0x0014, 0x0014, 0x0022, 0x0022, 0x0000, 0x0000, 0x0000}: "v",
	{0x001C, 0x0008, 0x0008, 0x0008, 0x0008, 0x0008, 0x000C, 0x0000}: "1",
	{0x0022, 0x0022, 0x0022, 0x0026, 0x001A, 0x0000, 0x0000, 0x0000}: "n",
	{0x001C, 0x0008, 0x0008, 0x0008, 0x0008, 0x0000, 0x0008, 0x0000}: "i",
	{0x0020, 0x003C, 0x0022, 0x0022, 0x001C, 0x0000, 0x0000, 0x0000}: "a",
	{0x003C, 0x0022, 0x003C, 0x0020, 0x001C, 0x0000, 0x0000, 0x0000}: "g",
	{0x0022, 0x0022, 0x0022, 0x0022, 0x001E, 0x0002, 0x0002, 0x0000}: "h",
	{0x0022, 0x0014, 0x0008, 0x0014, 0x0022, 0x0000, 0x0000, 0x0000}: "x",
	{0x0008, 0x0010, 0x0010, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000}: "'",
	{0x0008, 0x0010, 0x0010, 0x0000, 0x0018, 0x0018, 0x0000, 0x0000}: ";",
	{0x0004, 0x0008, 0x0014, 0x0022, 0x0022, 0x0000, 0x0000, 0x0000}: "y",
	{0x001E, 0x0022, 0x0022, 0x0022, 0x001E, 0x0002, 0x0002, 0x0000}: "b",
}
